      ...
      <div className="flex flex-wrap gap-3">
        {socialLinks.map((link, idx) => (
          <a
            ...
            className="flex items-center gap-2 px-4 py-2 bg-purple-50 border border-purple-200 text-purple-700 rounded-lg font-semibold shadow-sm hover:bg-purple-100 hover:text-purple-900 transition"
          >
