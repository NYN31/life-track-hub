  ...
  return (
    <div className="relative inline-block text-left" ref={dropdownRef}>
      <button
        ...
        className="flex items-center space-x-4 lg:space-x-2 bg-gray-50 border border-purple-200 dark:border-gray-600 hover:bg-purple-50 px-2 lg:px-3 py-2 rounded-full shadow-sm transition focus:outline-none focus:ring-2 focus:ring-purple-200 bg-gradient-to-r dark:from-gray-900 dark:to-gray-800"
      >
        <span className="w-8 h-8 rounded-full bg-purple-200 flex items-center justify-center text-purple-700 font-bold text-sm border border-purple-300">
          {initials}
        </span>
